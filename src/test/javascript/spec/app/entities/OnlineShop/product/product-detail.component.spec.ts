...
import { ProductDetailComponent } from 'app/entities/OnlineShop/product/product-detail.component';
import { Product } from 'app/shared/model/OnlineShop/product.model';
